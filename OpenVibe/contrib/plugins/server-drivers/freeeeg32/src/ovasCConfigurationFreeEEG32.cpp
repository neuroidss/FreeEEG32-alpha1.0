...
boolean CConfigurationFreeEEG32::setComInit(const CString& sComInit)
{
        m_sComInit=sComInit;
        return true;
}
...
CString CConfigurationFreeEEG32::getComInit(void) const
{
        return m_sComInit;
}

boolean CConfigurationFreeEEG32::setComDelay(uint32 iComDelay)
{
...
uint32 CConfigurationFreeEEG32::getComDelay(void) const
{
        return m_iComDelay;
}
