...
// #define TERM_SPEED CBR_921600 // FreeEEG32 is a bit faster than others
// #define TERM_SPEED CBR_115200 // FreeEEG32 is a bit faster than others
#define TERM_SPEED 930232 // FreeEEG32 is a bit faster than others
//#define TERM_SPEED 462427 // FreeEEG32 is a bit faster than others
// #define TERM_SPEED 2000000 // FreeEEG32 is a bit faster than others
 ...
 #include <unistd.h>
// #define TERM_SPEED 2000000
 #define TERM_SPEED 930232
//#define TERM_SPEED 462427
// #define TERM_SPEED 115273
// #define TERM_SPEED B921600
// #define TERM_SPEED B576000
// #define TERM_SPEED B500000
//#define TERM_SPEED B460800
// #define TERM_SPEED B230400
...
void  CDriverFreeEEG32::updateDaisy(bool bBeQuiet) {
	...
	IDriverCallback& rCallback)
{
	...
	// init scale factor
	ScaleFacuVoltsPerCount = (float32) (AD7770_VREF/(pow(2.,23)-1)/AD7770_GAIN*1000000.);
...
int32 CDriverFreeEEG32::interpret24bitAsInt32(std::vector < uint8 > byteBuffer) {
...
int32 CDriverFreeEEG32::interpret16bitAsInt32(std::vector < uint8 > byteBuffer) {
	// create a big endian so that we could adapt to host architecture later on
...
boolean CDriverFreeEEG32::initTTY(::FD_TYPE* pFileDescriptor, uint32 ui32TTYNumber)
{
	...
	*pFileDescriptor=::CreateFile(
	...
	{
		::sprintf(l_sTTYName, "/dev/ttyACM%d", ui32TTYNumber-20);
	}

	if((*pFileDescriptor=::open(l_sTTYName, //O_RDWR
	O_RDONLY))==-1)
	{
		m_rDriverContext.getLogManager() << LogLevel_Error << "Could not open port [" << CString(l_sTTYName) << "]\n";
		return false;
...
boolean CDriverFreeEEG32::boardWriteAndPrint(::FD_TYPE i32FileDescriptor, const char * cmd, bool waitForResponse, uint32 sleepBetween) {
...
boolean CDriverFreeEEG32::initBoard(::FD_TYPE i32FileDescriptor)
{
...
void CDriverFreeEEG32::fastReco(::FD_TYPE i32FileDescriptor)
{
...
void CDriverFreeEEG32::closeTTY(::FD_TYPE i32FileDescriptor)
{
#if defined TARGET_OS_Windows
...
bool CDriverFreeEEG32::handleCurrentSample(int32 packetNumber) {
...
int32 CDriverFreeEEG32::readPacketFromTTY(::FD_TYPE i32FileDescriptor)
{
